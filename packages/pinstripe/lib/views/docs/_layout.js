...
export default {
    async render(){
        const { title = 'Pinstripe', showSidebar = true, body } = this.params;
                    ...
                    <div class="navbar" data-test-id="navbar">
                        <div class="navbar-inner">
                            <div class="navbar-brand">
                                ...
                                <a class="navbar-item" href="/" data-test-id="title">Pinstripe</a>
                            </div>
                            <div class="navbar-buttons">
                                ...
                                <a class="navbar-button" href="https://github.com/pinstripe" target="_blank">Github</a>
                            </div>
                        </div>
                    </div>
                    <div class="site">
                        ...
                        <footer class="foot outer" data-test-id="footer">
                            <div class="foot-inner inner">
                                ...
                                <div class="powered-by">
                                    <a href="https://pinstripejs.com/" target="_blank" rel="noopener">Powered by Pinstripe</a>
                                </div>
                            </div>
                        </footer>
                    </div>
