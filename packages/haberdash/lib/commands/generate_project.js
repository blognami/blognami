...
export default {
   async run(){
      ...
      if(!dependencies.includes('haberdash')){
         dependencies.unshift('haberdash')
      }
      ...
      await generateDir(name, async () => {
         ...
         await generateFile(`haberdash.config.js`, () => {
            line();
         ...
         await generateFile(`lib/index.js`, () => {
            line();
            line(`import { importAll } from 'haberdash';`);
            dependencies.forEach((dependency) => {
               if(dependency != 'haberdash') line(`import '${dependency}';`);
            });
            line();
         ...
         await generateFile(`README.md`, () => {
            ...
            line('```bash');
            indent(() => {
               line('haberdash init-database');
               line('haberdash start-server');
            });
            line('```');
            line();
         });
