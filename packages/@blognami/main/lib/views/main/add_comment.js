...
export default {
    async render(){
        ...
        if(!this.user){
            return this.renderHtml`
                <span data-component="blognami-anchor" data-href="/sign_in?title=${encodeURIComponent('Add comment')}&redirectUrl=${encodeURIComponent(`/add_comment?commentableId=${this.params.commentableId}`)}">
    ...
    async success(comment){
        ...
        return this.renderHtml`
            <span data-component="blognami-anchor" data-target="_top">
                <script type="blognami">
                    this.parent.trigger('click');
                </script>
            </span>
