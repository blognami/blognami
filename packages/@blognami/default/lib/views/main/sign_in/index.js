            ...
            }),
            {
                ...
                success: async ({ email }) => {
                    ...
                    return this.renderHtml`
                        <span data-component="pinstripe-anchor" data-href="/sign_in/verify_password?email=${encodeURIComponent(email)}${optionalParams}"><script type="pinstripe">this.parent.trigger('click');</script></span>
                    `;
                }
            }
        );
