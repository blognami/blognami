...
The `list-jobs` command is a **discovery tool** that displays all jobs registered in your Blognami project. It scans the application and shows the names of all available jobs that can be executed.
