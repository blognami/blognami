...
The `list-models` command is a **database introspection tool** that displays all database models currently available in your Blognami project. Models are automatically registered when they extend the `Row` class from `@blognami/database`.
