...
The `list-services` command is a **project inspection tool** that displays all services available in the current Blognami project. Services are business logic components that handle application functionality like user management, content processing, or data manipulation.
