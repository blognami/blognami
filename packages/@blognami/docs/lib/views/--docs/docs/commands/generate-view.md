...
```bash
# Create a basic view
blognami generate-view home

# Create a view with specific extension
blognami generate-view contact.js

# Create a nested view
blognami generate-view admin/dashboard
```

## Description

The `generate-view` command creates new view files in the `lib/views/` directory. Views handle web requests and render HTML responses in Blognami applications.
