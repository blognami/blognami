...
Component.register('blognami-frame', {
    initialize(...args){
    ...
    async load(url = this.url, options = {}){
        ...
        const isHtmlRequest = acceptHeader.match(/text\/html|\*\/\*|application\/vnd\.blognami\.markup-node\+json/i);
        ...
        try {
            ...
            let body;
            if(contentTypeHeader.match(/application\/vnd\.blognami\.markup-node\+json/i)) {
