...
import { readdir, stat } from 'fs/promises'; // sintra-if-client: const readdir = undefined, stat = undefined;
import { existsSync as exists } from 'fs'; // sintra-if-client: const exists = undefined;
import { dirname } from 'path'; // sintra-if-client: const dirname = undefined;
