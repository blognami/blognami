...
import postcss from 'postcss'; // sintra-if-client: const postcss = null;
import postcssOkLab from '@csstools/postcss-oklab-function'; // sintra-if-client: const postcssOkLab = null;
import postcssAutoprefixer from 'autoprefixer'; // sintra-if-client: const postcssAutoprefixer = null;
import postcssMinifySelectors from 'postcss-minify-selectors'; // sintra-if-client: const postcssMinifySelectors = null;
...
export default {
    ...
    transform(styles){
        ...
        ]).process(styles).then(result => result.css);
    }
};
