...
export default {
    async render(){
        ...
        const versionedMeta = [
            { tagName: 'link', rel: 'stylesheet', href: `/_blognami/_shell/styles.css?${urlSearchParams}` },
            { tagName: 'script', src: `/_blognami/_shell/window.js?${urlSearchParams}` },
            { tagName: 'meta', name: 'blognami-service-worker-url', content: `/service_worker.js?${urlSearchParams}` },
        ];
    ...
    defaultMeta: [
        ...
        { tagName: 'meta', name: 'blognami-load-cache-namespace', content: 'guest' },
    ],
