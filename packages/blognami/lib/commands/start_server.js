...
export default {
    meta(){
        ...
        this.hasParam('host', {
            type: 'string',
            optional: true,
            description: 'Host and port configuration (e.g. "127.0.0.1:3000"). Defaults to BLOGNAMI_HOST environment variable or "127.0.0.1:3000".'
        });
    ...
    async run(){
        ...
        const {
            host = process.env.BLOGNAMI_HOST || '127.0.0.1:3000',
            withoutJobs = false
        } = this.params;
